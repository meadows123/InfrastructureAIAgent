...
def execute_show_run():
    ...
    #for int in learned_config:
        #print(f" Name: {int}, IP:{learned_config[int]['ip_address']}, Status: {learned_config[int]['status']}")
...
def learn_config_tool(dummy_input: str = "") -> dict:
    """Excute show run running-config on the router using pyATS to return the running-configuration."""
