...
tools = [run_show_command_tool, check_supported_command_tool, apply_configuration_tool, learn_config_tool, learn_logging_tool, run_ping_command_tool]

# Render text descriptions for the tools for inclusion in the prompt
tool_descriptions = render_text_description(tools) #This renders the tool name and description in plain text for the output.
